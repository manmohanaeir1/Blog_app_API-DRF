...
SECRET_KEY = 'django-insecure-svag$)lzsxj!^r7ci3r4k+s=yg1+azzz_hhe71ce+$ujoltczo'
...
# Global  pgination settings for Django REST Framework =  for only Generic API views
REST_FRAMEWORK = {
